...
```{bash, eval=FALSE}
usage: MAESTRO [-h] [-v]
               {scrna-init,scatac-init,integrate-init, fast-scatac-init, samples-init, mtx-to-h5,count-to-h5,merge-h5,scrna-qc,scatac-qc,scatac-peakcount,scatac-genescore}
```
