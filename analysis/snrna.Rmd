...
Arguments  |  Description
---------  |  -----------
`--STARsolo_Features` | {Gene,GeneFull,Gene GeneFull,SJ,Velocyto} Parameters passed to STARsolo --soloFeatures. Specify --soloFeatures Gene for single-cell data. Specify --soloFeatures GeneFull for single-nuclei data. Specify --soloFeatures Gene GeneFull for getting both counts in exons level and exon + intron level (velocity). DEFAULT: Gene.
